...
class AdminsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admins')->insert([
            ['id' => 1, 'username' => 'admin', 'email' => 'admin@trioangle.com', 'password' => Hash::make('123456'), 'status' => 'Active', 'created_at' => '2016-04-17 00:00:00', 'country_code' => '91', 'mobile_number' => '01067123849',
            ],
            ['id' => 2, 'username' => 'dispatcher', 'email' => 'dispatcher@trioangle.com', 'password' => Hash::make('123456'), 'status' => 'Active', 'created_at' => '2016-04-17 00:00:00', 'country_code' => '91', 'mobile_number' => '01067123849',
            ],
        ]);

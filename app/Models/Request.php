...
class Request extends Model
{
    ...
    protected $appends = ['accepted_count','pending_count','cancelled_count',
                            'total_count','date_time','total_fare',
                            'payment_status','currency_code','currency_symbol'];
    protected $dates = ['deleted_at'];
    protected $fillable = ['user_id','group_id','driver_id','status',
        'pickup_latitude','pickup_longitude','drop_latitude','drop_longitude',
        'pickup_location','drop_location','car_id','timezone','location_id',
        'payment_mode','schedule_id','peak_fare'];

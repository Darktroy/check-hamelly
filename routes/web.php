...
// Route::get('test', 'HomeController@test');
    ...
    Route::post('login_company','UserController@login_company' );
//    Route::post('login_company', 'UserController@login_company');
...
//    });
    ...
    Route::group(['middleware' => 'admin_can:manage_manual_booking'], function () {
        ...
        Route::post('pick_ride_to_company', 'Admin\LaterBookingController@pick_ride_to_company');
        ...
        //pick this request
        Route::get('pick-this-request/{id}', 'Admin\LaterBookingController@pickThisRequest');
    });

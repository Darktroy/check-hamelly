          ...
          <div class="box box-info">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="input_app_store" class="col-sm-3 control-label">App store link to client</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label for="input_play_store" class="col-sm-3 control-label">Play store link to client</label>
                  <div class="col-sm-6">

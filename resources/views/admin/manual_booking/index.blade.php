		...
		<div class="clearfix">
			<div class="col-md-4 location-form">
				...
				<div class="row clearfix" ng-init="vehicle_type_value = '{{@$schedule_ride->car_id}}'">
					<div class="col-md-12">
						<select class='form-control change_field' ng-cloak placeholder ='Select Truck Type' name="vehicle_type" id="input_vehicle_type" ng-model="vehicle_type_value" ng-change="list_driver()" disabled >

    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        @if(@$user->can('view_rider'))
          <li class="{{ (Route::current()->uri() == 'admin/rider') ? 'active' : ''  }}"><a href="{{ url('admin/rider') }}"><i class="fa fa-users"></i><span>Manage clients</span></a></li>
        @endif

        @if(@$user->can('view_company'))
          <li class="{{ (Route::current()->uri() == 'admin/company') ? 'active' : ''  }}"><a href="{{ url('admin/company') }}"><i class="fa fa-building"></i><span>Manage Organization</span></a></li>
        @endif
        ...
        @if($company_user || @$user->can('manage_vehicle'))
          <li class="{{ (Route::current()->uri() == $first_segment.'/vehicle') ? 'active' : ''  }}"><a href="{{ url($first_segment.'/vehicle') }}"><i class="fa fa-taxi"></i><span>Manage Trucks</span></a></li>
        @endif

         @if(@$user->can('manage_car_type'))
          <li class="{{ (Route::current()->uri() == 'admin/car_type') ? 'active' : ''  }}"><a href="{{ url('admin/car_type') }}"><i class="fa fa-car"></i><span>Manage Trucks Type</span></a></li>
        @endif

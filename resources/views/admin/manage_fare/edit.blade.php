      ...
      <div class="col-md-8 col-sm-offset-2">
        ...
        <div class="box box-info">
          ...
          <div class="box-body" ng-init="time_options={{ json_encode($time_options) }};day_options={{json_encode($day_options)}};">
            ...
            <div class="form-group">
              <label for="input_name" class="col-sm-3 control-label">
                Truck Name <em class="text-danger">*</em>
              </label>
              <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">30 - 100 <em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    {!! Form::text('distrance_30_100', $result->distrance_30_100, ['class' => 'form-control', 'id' => '', 
                    'placeholder' => '30 - 60 km Fare']) !!}
                    <span class="text-danger">{{ $errors->first('distrance_30_100') }}</span>
                  </div>
              </div>
            
              <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">100 - 400 <em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    {!! Form::text('distrance_100_400', $result->distrance_100_400, ['class' => 'form-control', 'id' => '', 
                    'placeholder' => '100 - 400 km Fare']) !!}
                    <span class="text-danger">{{ $errors->first('distrance_100_400') }}</span>
                  </div>
              </div>
            
              <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">400 - 600 <em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    {!! Form::text('distrance_400_600', $result->distrance_400_600, ['class' => 'form-control', 'id' => '', 
                    'placeholder' => '400 - 600 km Fare']) !!}
                    <span class="text-danger">{{ $errors->first('distrance_400_600') }}</span>
                  </div>
              </div>
            
              <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">600 - 800 <em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    {!! Form::text('distrance_600_800', $result->distrance_600_800, ['class' => 'form-control', 'id' => '', 
                    'placeholder' => '600 - 800 km Fare']) !!}
                    <span class="text-danger">{{ $errors->first('distrance_600_800') }}</span>
                  </div>
              </div>
            
              <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label"> 800 < <em class="text-danger">*</em></label>
                  <div class="col-sm-6">
                    {!! Form::text('distrance_800', $result->distrance_800, ['class' => 'form-control', 'id' => '', 
                    'placeholder' => '800 km < ... Fare']) !!}
                    <span class="text-danger">{{ $errors->first('distrance_800') }}</span>
                  </div>
              </div>

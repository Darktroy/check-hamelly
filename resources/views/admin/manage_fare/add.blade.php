          ...
          <div class="box-body" ng-init="time_options={{ json_encode($time_options) }};day_options={{json_encode($day_options)}};">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('distrance_30_100', '', ['class' => 'form-control', 'id' => '', 
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('distrance_100_400', '', ['class' => 'form-control', 'id' => '', 
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('distrance_400_600', '', ['class' => 'form-control', 'id' => '', 
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('distrance_600_800', '', ['class' => 'form-control', 'id' => '', 
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('distrance_800', '', ['class' => 'form-control', 'id' => '', 

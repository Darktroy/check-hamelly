        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Truck types  Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
           {!! Form::open(['url' => 'admin/add_car_type', 'class' => 'form-horizontal','files' => true]) !!}
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <span class="text-danger">{{ $errors->first('description') }}</span>
                      ...
                      <div class="form-group">
                <label for="input_license_back" class="col-sm-3 control-label">Truck image <em class="text-danger">*</em></label>
                <div class="col-sm-6">
                ...
                <span class="text-danger">{{ $errors->first('vehicle_image') }}</span>
                 ...
                 <div class="form-group">
                <label for="input_license_back" class="col-sm-3 control-label">Truck Active image <em class="text-danger">*</em></label>
                <div class="col-sm-6">

              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label radio_label">User Type<em class="text-danger">*</em></label>
                    ...
                    <label class="user_label" for="all_type">client & Driver & Company</label>
                    </div>
                    <div class="col-sm-2">
                      <input type="radio" id="all_rider"  name="user_type" value="client" class="get_user_class get_user_type">
                      <label class="user_label" for="all_rider" >client</label>
                    </div>
                  <div class="col-sm-2">

            ...
            <!-- form start -->
              ...
              <div class="box-body">                
                <div class="form-group">
                  <label for="input_service_fee" class="col-sm-3 control-label">client Service Fee</label>
                  <div class="col-sm-7">
                  <div class="input-group"> 
                    {!! Form::text('access_fee', $result[0]->value, ['class' => 'form-control', 'id' => 'input_service_fee', 'placeholder' => 'client Service Fee']) !!}
